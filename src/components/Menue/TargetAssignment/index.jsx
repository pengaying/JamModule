...
export default class TargetAssignment extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tt: 1,
            ...
            <div className={styles.JammingMode}>
                <div className={styles.JamButton}>
                    <div className={styles.Image_Area} onClick={this.handleClick} onMouseEnter={this.onMouseOver} onMouseLeave={this.onMouseOut}>
                        <Link to='/rtargetAllocation' ><img src={require('../../../assets/Cardinal_132.png')} className={styles.Image} alt='图片' /></Link>
                    </div>
