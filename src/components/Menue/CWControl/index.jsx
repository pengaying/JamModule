...
export default class CWControl extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tt: 1,
            ...
            <div className={styles.JammingMode}>
                <div className={styles.JamButton}>
                    <div className={styles.Image_Area} onClick={this.handleClick} onMouseEnter={this.onMouseOver} onMouseLeave={this.onMouseOut}>
                        <Link to='/rcwcontrol' ><img src={require('../../../assets/Cardinal_132.png')} className={styles.Image} alt='图片' /></Link>
                    </div>
                ...
                <div className={styles.ToolButton_Title}>
                    <span style={{ fontFamily: '微软雅黑', color: '#909cb9' }}>连续波控制</span>
                </div>
            </div>
        )
    }
