...
export default class FloatingWindows extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tt: 1,
            ...
            <div className={styles.JammingMode}>
                <div className={styles.JamButton}>
                    <div className={styles.Image_Area} onClick={this.handleClick} onMouseEnter={this.onMouseOver} onMouseLeave={this.onMouseOut}>
                        <Link to='/displayJammingMode' ><img src={require('../../../assets/Activity_Monitor.png')} className={styles.Image} alt='图片' /></Link>
                    </div>
